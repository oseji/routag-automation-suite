...
class TransactionPinPage {
  private locators = {
    transactionPinScreenHeading: 'android=new UiSelector().text("Transaction Pin")',
  ...
  async completeTransactionPinScreenFlow(isValidPin: boolean, pin: string): Promise<void> {
