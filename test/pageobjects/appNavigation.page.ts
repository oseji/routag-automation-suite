...
class appNavigationPage {
	...
	async navigateToPickupScreen(): Promise<void> {
		await waitAndClick(await $(this.locators.pickupButton), "Pickup button");
	}
	...
	async navigateToWalletScreen(): Promise<void> {
		await waitAndClick(await $(this.locators.walletButton), "Wallet button");
	}

	async navigateToAccountScreen(): Promise<void> {
		await waitAndClick(await $(this.locators.accountButton), "Account button");
	}
